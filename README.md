...
| 5    | Django & Vue 프로젝트 생성 및 기본 연결 설정 + CORS | 공통   | 5/20   | 5/20   | 완료      |
| 6    | Django 모델 작성                                    | 공통   | 5/20   | 5/20   | 수정중    |
| 7    | Django Admin 관리자 생성 및 등록                    | 혜령   | 5/22   | 5/22   | 완료      |
| 8    | Django serializer 작성                              | 유주   | 5/20   | 5/25   | 작업중    |
| 9    | Django views.py 작성 (알고리즘 제외)                | 공통   | 5/20   | 5/25   | 작업중    |
| 10   | 추천 알고리즘 개발                                  | 공통   | 5/20   | 5/25   | 작업중    |
| 11   | 개발용 테스트 데이터 생성                           | 유주   | 5/20   | 5/20   | 완료      |
| 12   | POSTMAN으로 API 테스트                              | 공통   | 5/20   | 5/25   | 작업중    |
| 13   | Django Authentication & Authorization 기능 구현     | 공통   | 5/20   | 5/24   | 5/23 완료 |
...
|      | 커뮤니티 게시글 좋아요                              | 유주   | 5/20   | 5/20   | 수정중    |
|      | 커뮤니티 게시글 조회수                              | 공통   | 5/22   | 5/23   | 작업중    |
|      | 커뮤니티 게시글 시간                                | 혜령   | 5/21   | 5/21   | 완료      |
|      | 커뮤니티 게시글 수정 여부                           | 혜령   | 5/21   | 5/21   | 수정중    |
